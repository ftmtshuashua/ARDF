 ...
 */
@Deprecated
public class WebProgressBar2 extends TimelineView2 {
    ...
    public WebProgressBar2(Context context) {
        super(context);
        init();
    }

    public WebProgressBar2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WebProgressBar2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
