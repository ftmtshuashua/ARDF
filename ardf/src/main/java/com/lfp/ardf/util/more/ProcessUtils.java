 ...
 *      进程相关工具类
 * function:
 *      getForegroundProcessName()  :获得前台进程名称
 *      getAllBackgroundProcesses()  :获得所有后台进程
 *      killAllBackgroundProcesses()  :杀死所有后台进程
 *      killBackgroundProcesses()  :杀死后台进程
...
public class ProcessUtils {
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(AppUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
    ...
    public static boolean isMainProcess() {
        return AppUtils.getApp().getPackageName().equals(getCurrentProcessName());
    }
